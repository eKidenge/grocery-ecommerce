...
#for showing login button for admin(by Kidenge)
...
def logout_view(request):
    if request.method == "POST":
        logout(request)
        return redirect('login')  # Or to any other page after logout
    else:
        return HttpResponseForbidden("Forbidden: Use POST for logout")
#---------------------------------------------------------------------------------
